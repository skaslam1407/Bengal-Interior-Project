            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 800px;">
                            <h3 class="text-primary text-uppercase font-weight-normal mb-md-3">Welcome to Bengal Interior</h3>
                            <h4 class="display-3 text-white mb-md-4">Innovatively designed spaces with Bengal Interior.</h4>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 800px;">
                            <h3 class="text-primary text-uppercase font-weight-normal mb-md-3">Welcome to Bengal Interior</h3>
                            <h4 class="display-3 text-white mb-md-4">Turn your dream into reality.</h4>
                            <a href="<?php echo site_url();?>/gallery" class="btn btn-primary py-md-3 px-md-5 mt-2 mt-md-4">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 800px;">
                            <h3 class="text-primary text-uppercase font-weight-normal mb-md-3">Welcome to Bengal Interior</h3>
                            <h4 class="display-3 text-white mb-md-4">Discover the Perfect Sofa for Your Resident</h4>
                            <a href="<?php echo site_url();?>/gallery" class="btn btn-primary py-md-3 px-md-5 mt-2 mt-md-4">Learn More</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 800px;">
                            <h3 class="text-primary text-uppercase font-weight-normal mb-md-3">Welcome to Bengal Interior</h3>
                            <h4 class="display-3 text-white mb-md-4">Relax in style with our designer sofas</h4>
                            <a href="<?php echo site_url();?>/gallery" class="btn btn-primary py-md-3 px-md-5 mt-2 mt-md-4">Learn More</a>
                        </div>
                    </div>
                </div>
              ...
              <div class="row">
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/residential.jpg" alt="residential">
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/corporate.jpg" alt="corporate">
                        <div class="overlay_gal"></div>
                    </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/spatial_branding.jpg" alt="spatial_branding">
                        <div class="overlay_gal"></div>
                    </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/hotel_restaurant.jpg" alt="hotel_restaurant">
                        <div class="overlay_gal"></div>
                    </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/hospital.jpg" alt="hospital">
                        <div class="overlay_gal"></div>
                    </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/landsaping.jpg" alt="landsaping">
                        <div class="overlay_gal"></div>
                    </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/spa_hospitality.jpg" alt="spa_hospitality">
                        <div class="overlay_gal"></div>
                    </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/furniture.jpg" alt="furniture">
                        <div class="overlay_gal"></div>
                    </div>
                  ...
                  <div class="col-12 col-sm-6 col-lg-4 py-3">
                    ...
                    <div class="image_gal_box">
                        <img class="social-photo" src="<?php echo get_template_directory_uri(); ?>/assets/service/corporate2.jpg" alt="indoor interior">
                        <div class="overlay_gal"></div>
                    </div>
...
<!--                                 <div class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/marriott.png" alt="marriott" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/acce-global-software.png" alt="acce-global-software" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/apolloClinic.png" alt="apolloClinic" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/iris-hospital.png" alt="iris-hospital" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/elphill-technology.png" alt="elphill-technology" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/emami-biotech.png" alt="emami-biotech" class="client-logos">
                    </div>
         ...
         <div class="row">
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/bp-poddar-hospital.png" alt="bp-poddar-hospital" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/nh-narayana.png" alt="nh-narayana" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/fortish.png" alt="fortish" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/aqb-solutions.jpg" alt="aqb-solutions" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/ginesys.jpg" alt="ginesys" class="client-logos">
                    </div>
                    
                </div>
                <div class="col-md-2 col-6 p-0">
                    <div class="pad_zero">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/client-logos/hyatt.png" alt="hyatt" class="client-logos">
                    </div>
    ...
    <div class="hero-image-seo">
        <img class="w-100 d-block" src="/wp-content/themes/twentytwenty/assets/images/banner2.jpg" alt="seo banner">
        <div class="hero-text-seo">
          <div class="container">
            <div class="row pos_rltv">
              <div class="col-lg-8 col-md-8 mt-4 mt-md-0 pl-lg-5">
                <h2 class="elementor-heading-title elementor-size-default">If You Have Any Question, <br>Feel Free to Call <br>+91-9735240010</h2>
                <p>Give us an opportunity to build beautiful spaces for your awesome business, residents and retails.
    
                </p>
                <a href="<?php echo site_url();?>/free-consult" class="btn btn-primary mt-3 py-2 px-4">Let's Work Together</a>
              </div>
